  ...
  return (
    <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Get In Touch</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div>
              <h3 className="font-sans text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Contact Information</h3>
            ...
            <div>
              <h3 className="font-sans text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Connect With Me</h3>
              <div className="space-y-3 sm:space-y-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-muted-foreground text-sm sm:text-base truncate">{social.username}</p>
                      </div>
                    </a>
                  </motion.div>
                ))}
          ...
          >
            <Card>
              <CardHeader className="pb-4 sm:pb-6">
                <CardTitle className="font-sans text-lg sm:text-xl">Send Me a Message</CardTitle>
